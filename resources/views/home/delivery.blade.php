...
<main class="flex">
    <section class="flex-content padding_1x">
        <article>
            <h1 class="title big">Delivery <em> Home</em> Services</h1>
        </article>
    </section>
...
<div class="section1">
    <section class="flex-content padding_2x">
        ...
        <br>
        <h1 class="title medium">We simplify your life by delivering essential products and services to your doorstep.</h1>
    ...
    <section class="flex-content padding_2x">
        <form id="form" class="padding_2x" method="POST" action="{{ route('app_deliveryafter')}}">
            @csrf
            ...
            <fieldset>
                ...
                <select name="service" id="service" required>
                    <option value="Electronics Delivery">Electronics Delivery</option>
...
<div class="section3 padding_2x">
    ...
    <section class="flex-content padding_1x">
        <figure>
            <img src="{{asset('images/del1.jpg')}}" alt="">
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Electronics Delivery</h2>
                    <p>
                        Electronics delivery ensures the safe and timely transportation of electronic devices and appliances right to your doorstep, providing convenience and peace of mind.</p>
                </span>
            </article>
        </figure>
    </section>
    <section class="flex-content padding_1x">
        <figure>
            ...
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Meal Delivery</h2>
                    <p> Meal delivery offers a convenient solution for enjoying delicious and freshly prepared meals delivered straight to your door, saving you time and effort in meal planning and preparation.</p>
                </span>
            </article>
        </figure>
    </section>
    <section class="flex-content padding_1x">
        <figure>
            <img src="{{asset('images/grocery.jpg')}}" alt="">
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Grocery Delivery</h2>
                    <p>
                        Grocery delivery brings the convenience of having groceries and household essentials delivered to your doorstep, saving you time and making shopping more efficient.</p>
                </span>
            </article>
        </figure>
    </section>
    <section class="flex-content padding_1x">
        <figure>
            <img src="{{asset('images/FURNITURE-DELIVERY.webp')}}" alt="">
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Furniture Delivery</h2>
                    <p>Furniture delivery provides a hassle-free solution for receiving and assembling furniture items, making it easier to furnish your home without the challenges of transportation and logistics</p>
                </span>
            </article>
        </figure>
    </section>
...
main{
    width:100%;
    position:relative;
    background:linear-gradient(to right, #33b5e5 10%, rgba(214, 233, 247, 0.7) 50%, rgba(31, 28, 88, 0.1) 100%),url("https://th.bing.com/th/id/R.d9015f949dc78c6782d34b9922276919?rik=oVeBK04L0AExlA&riu=http%3a%2f%2fwww.sunrisewholesalemerchandise.com%2fimages%2fdropshipMobile.jpg&ehk=U9XBc50M9lOE%2fRnrfz46viAgLmZKv9YVdUJvceg09IQ%3d&risl=&pid=ImgRaw&r=0");
...
.section2{
    background:linear-gradient(to right, #33b5e5 10%, rgba(214, 233, 247, 0.7) 50%, rgba(31, 28, 88, 0.1) 100%),url("https://images.summitmedia-digital.com/reportrworld/images/2020/12/16/shutterstock-1366367039-1608093256.jpg");
    background-repeat:no-repeat;
    background-size:cover;
    color: white;
    position:relative;

...
<main class="flex">
    <section class="flex-content padding_1x">
        <article>
            <h1 class="title big">Repair <em> Home</em> Services</h1>
        </article>
    </section>
...
<div class="section1">
    <section class="flex-content padding_2x">
        ...
        <br>
        <h1 class="title medium">We help you to repair your home </h1>
        ...
        <form id="form" class="padding_2x" method="POST" action="{{ route('app_homerepairafter')}}">
            ...
            <fieldset>
                ...
                <select name="service" id="service">
                    ...
                    <option value="Fixing electrical problems">Fixing electrical problems</option>
...
<div class="section3 padding_2x">
    ...
    <section class="flex-content padding_1x">
        <figure>
            <img src="{{asset('images/plumbing.jpg')}}" alt="">
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Plumbing</h2>
                    <p>Plumbing services encompass a range of tasks, from fixing leaky faucets and repairing clogged drains to installing new pipes and ensuring efficient water flow throughout a home.</p>
                </span>
            </article>
        </figure>
    </section>
    <section class="flex-content padding_1x">
        <figure>
            <img src="{{asset('images/electric.jpg')}}" alt="">
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Fixing electrical problems</h2>
                    <p>Fixing electrical problems requires the expertise of skilled professionals who can identify and resolve issues such as faulty wiring, electrical outages, flickering lights, or malfunctioning electrical appliances for a safe and reliable electrical system in the home.</p>
                </span>
            </article>
        </figure>
    </section>
    <section class="flex-content padding_1x">
        <figure>
            <img src="{{asset('images/paint.webp')}}" alt="">
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Painting</h2>
                    <p>Painting services involve transforming the look and feel of a home by applying fresh coats of paint, repairing imperfections, and skillfully applying colors to walls, ceilings, trims, and other surfaces, enhancing the overall aesthetic appeal and ambiance of the space.</p>
                </span>
            </article>
        </figure>
    </section>
    <section class="flex-content padding_1x">
        <figure>
            <img src="{{asset('images/carpent.jpeg')}}" alt="">
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Carpentry</h2>
                    <p>Carpentry services encompass a wide range of tasks, including constructing and repairing wooden structures, installing cabinets and furniture, building custom shelves or closets, and ensuring precise measurements and craftsmanship to create functional and visually appealing elements within a home.</p>
                </span>
            </article>
        </figure>
    </section>
...
main{
    width:100%;
    position:relative;
    background:linear-gradient(to right, #33b5e5 10%, rgba(214, 233, 247, 0.7) 50%, rgba(31, 28, 88, 0.1) 100%),url("https://scontent.frba4-2.fna.fbcdn.net/v/t1.6435-9/105289768_3136354189749684_7805410302857153338_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=9267fe&_nc_ohc=RZ4L3gyoA8MAX-a8zfC&_nc_ht=scontent.frba4-2.fna&oh=00_AfARbhbIjqiH9KMNC5rjV_DbgR5uo50tx290Dz2mWjI0Pg&oe=64999929");
...
.section2{
    background:linear-gradient(to right, #33b5e5 10%, rgba(214, 233, 247, 0.7) 50%, rgba(31, 28, 88, 0.1) 100%),url("https://th.bing.com/th/id/R.2a463a2cabd07e894899d99c03b57f5f?rik=rf88%2fOMdXF8y7Q&pid=ImgRaw&r=0");
    background-repeat:no-repeat;
    background-size:cover;
    color: white;
    position:relative;

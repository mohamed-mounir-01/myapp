...
<main class="flex">
    <section class="flex-content padding_1x">
        <article>
            <h1 class="title big">Gardener <em> Home</em> Services</h1>
        </article>
    </section>
...
<div class="section1">
    <section class="flex-content padding_2x">
        ...
        <br>
        <h1 class="title medium">We help you to keep your garden clean</h1>
        <p> &nbsp; &nbsp; &nbsp;
    ...
    <section class="flex-content padding_2x">
        <form id="form" class="padding_2x"  method="POST" action="{{ route('app_gardenerafter')}}">
            @csrf
            ...
            <fieldset>
                ...
                <select name="service" id="service" required>
                    <option value="Soil preparation and fertilization">Soil preparation and fertilization</option>
                    <option value="Garden design and landscaping">Garden design and landscaping</option>
...
<div class="section3 padding_2x">
    ...
    <section class="flex-content padding_1x">
        <figure>
            <img src="{{asset('images/soil.jpeg')}}" alt="">
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Soil preparation and fertilization</h2>
                    <p>We offer professional soil preparation and fertilization services to ensure that your plants thrive in a healthy and nourishing environment.</p>
                </span>
            </article>
        </figure>
    </section>
    <section class="flex-content padding_1x">
        <figure>
            <img src="{{asset('images/LandScaping-Property-Lines.webp')}}" alt="">
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Garden design and landscaping</h2>
                    <p>Our expert team specializes in garden design and landscaping, creating stunning outdoor spaces tailored to your preferences and lifestyle.</p>
                </span>
            </article>
        </figure>
    </section>
    <section class="flex-content padding_1x">
        <figure>
            ...
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Watering garden</h2>
                    <p>We provide reliable watering services to keep your garden hydrated and thriving, ensuring that your plants receive the necessary care and attention they need.</p>
                </span>
            </article>
        </figure>
    </section>
    <section class="flex-content padding_1x">
        <figure>
            <img src="{{asset('images/transplanting.jpg')}}" alt="">
            <article>
                <span class="padding_1x">
                    <h2 class="cursive">Planting and transplanting</h2>
                    <p>Our skilled team specializes in planting and transplanting services, ensuring that your garden is filled with healthy and vibrant plants in the right locations.</p>
                </span>
            </article>
        </figure>
    </section>
...
main{
    width:100%;
    position:relative;
    background:linear-gradient(to right, #33b5e5 10%, rgba(214, 233, 247, 0.7) 50%, rgba(31, 28, 88, 0.1) 100%),url("https://4.imimg.com/data4/IK/RO/MY-29076740/gardener-service-500x500.jpg");
...
.section2{
    background:linear-gradient(to right, #33b5e5 10%, rgba(214, 233, 247, 0.7) 50%, rgba(31, 28, 88, 0.1) 100%),url("https://blog.fantasticservices.com/wp-content/uploads/2020/04/gardener-with-mask.jpg.webp");
    background-repeat:no-repeat;
    background-size:cover;
    color: white;
    position:relative;

        ...
        <div class="row">
            <div class="col-md-4 mx-auto">
                ...
                <form action="{{route('app_forgot_password')}}" method="POST">
                    ...
                    <input type="email" class="form-control @error('email-error') is-invalid @enderror" name="email-send" id="email-send" placeholder="Please enter your email address" value="@if(Session::has('old_email')){{Session::get('old_email')}}@endif" required>
